...
//Setting up server
 var server = https.createServer(options,app).listen(process.env.PORT || 3003, function () {
...
app.get("/api/user", function(req , res){
   ...
   //res.send("LOL\\Hello...");
                var query = "Select * from dbo.tSystemNewsMailDL";
                executeQuery (res, query);
});

//POST API
 app.post("/api/user", function(req , res){
                var query = "INSERT INTO dbo.tSystemNewsMailDL (DL,DLName,Product,Landscape,DLSubscriptionLink) VALUES (' " + req.body.DL + " ',' " + req.body.DLName + " ',' " + req.body.Product + " ',' " + req.body.Landscape + " ',' " + req.body.DLSubscriptionLink + " ')";
                executeQuery (res, query);
});
